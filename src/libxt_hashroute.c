...
static void hashroute_mt4_init(struct xt_entry_match *match)
{
...
static void hashroute_mt6_init(struct xt_entry_match *match)
{
	struct xt_hashroute_mtinfo *info = (void *)match->data;
...
static void
hashroute_mt4_print(const void *ip, const struct xt_entry_match *match,
                   int numeric)
{
...
static void
hashroute_mt6_print(const void *ip, const struct xt_entry_match *match,
                   int numeric)
{
	const struct xt_hashroute_mtinfo *info = (const void *)match->data;
...
static void
hashroute_mt4_save(const void *ip, const struct xt_entry_match *match)
{
	const struct xt_hashroute_mtinfo *info = (const void *)match->data;
...
static void
hashroute_mt6_save(const void *ip, const struct xt_entry_match *match)
{
	const struct xt_hashroute_mtinfo *info = (const void *)match->data;
...
static struct xtables_match hashroute_mt_reg[] = {
	{
...
void _init(void)
{
	xtables_register_matches(hashroute_mt_reg, ARRAY_SIZE(hashroute_mt_reg));
}
